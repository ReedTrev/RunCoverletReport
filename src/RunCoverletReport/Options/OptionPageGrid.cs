namespace RunCoverletReport.Options
{
    ...
    public class OptionPageGrid : DialogPage, IOptionPageGrid
    {
        ...
        [DisplayName("Specify coverlet.runsettings File")]
        [Description("Path to a coverlet.runsettings file for use during the dotnet test command.")]
        public string CoverletRunsettingsPath { get; set; } = ".\\coverlet.runsettings";
